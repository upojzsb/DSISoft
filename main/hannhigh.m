function [dataout]=hannhigh(datain,stopband,passband)

%[dataout]=hannhigh(datain,stopband,passband)
%
%This function will filter your data using a highpass
...
%$Id: hannhigh.m,v 3.0 2000/06/13 19:20:24 gilles Exp $
%$Log: hannhigh.m,v $
%Revision 3.0  2000/06/13 19:20:24  gilles
%Release 3
%
%Revision 2.0  1999/05/21 18:45:42  mah
%Release 2
%
%Revision 1.1  1999/01/25 21:56:45  mah
%Initial revision
%
%
...
disp('[dataout]=hannhigh(datain,passband,stopband)')
