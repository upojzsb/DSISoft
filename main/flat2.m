function [dataout]=flat2(datain,datum_time,word)
%
%function [dataout]=flat2(datain,datum_time,word)
%
%The funcion flat2 flattens the times stored in a header word to a desired datum time
%
%Input arguments are:
% datain= input data in official DSI format
% datum_time= datum time at which to flat data in seconds
% word=	header word containing the picked times of the horizon
%
%DSI customized VSP processing software
%Written by Marko Mah February 1999

%$Id: flat2.m,v 3.0 2000/06/13 19:20:18 gilles Exp $
%$Log: flat2.m,v $
%Revision 3.0  2000/06/13 19:20:18  gilles
%Release 3
%
%Revision 2.0  1999/05/21 18:45:37  mah
%Release 2
%
%Revision 1.1  1999/02/09 21:40:55  mah
%Initial revision
%
%
%
...
disp('[dataout]=flat2(datain,datum_time,word)');
...
for COUNT1=1:nrec
 ...
 for COUNT2=1:ntraces
  ...
  shift=datum_time-datain.th{COUNT1}(word,COUNT2);
