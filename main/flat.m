function [dataout]=flat(datain,flt_time,headw1)
%
%function [dataout]=flat(datain,flt_time,headw1)
%
%The funcion flat an the times stored in a header number to a desired time
%
...
%$Id: flat.m,v 3.0 2000/06/13 19:20:16 gilles Exp $
%$Log: flat.m,v $
%Revision 3.0  2000/06/13 19:20:16  gilles
%Release 3
%
%Revision 2.0  1999/05/21 18:45:35  mah
%Release 2
%
...
for COUNT=1:datain.fh{12}	%loop over records
	...
	for i=1:m
	  ...
	  if diff_num(i) > 0
	    dataout.dat{COUNT}(1:n-diff_num(i)+1,i)=datain.dat{COUNT}(diff_num(i):n,i);
