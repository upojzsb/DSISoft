function [dataout]=noch(datain,F1,F2,F3,F4)

%[dataout]=noch(datain,F1,F2,F3,F4)
%
%noch filter
%
...
%$Id: noch.m,v 3.0 2000/06/13 19:20:57 gilles Exp $
%$Log: noch.m,v $
%Revision 3.0  2000/06/13 19:20:57  gilles
%Release 3
%
%Revision 2.0  1999/05/21 18:46:08  mah
%Release 2
%
%Revision 1.2  1999/05/17 17:16:06  mah
%fixed help message
%
...
disp('[dataout]=noch(datain,F1,F2,F3,F4)');
